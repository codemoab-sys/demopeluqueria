...
<div class="card-modern" style="max-width:560px;margin:0 auto;">
    ...
    <form method="POST" action="{{ route('categorias-productos.update', $categoria) }}" class="card-body">
        @csrf @method('PUT')
        ...
        <div class="d-flex justify-content-between"><a href="{{ route('categorias-productos.index') }}" class="btn btn-soft">Cancelar</a><button class="btn btn-primary">Guardar</button></div>
    </form>
</div>
@endsection
